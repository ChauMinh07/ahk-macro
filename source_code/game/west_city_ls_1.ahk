...
;Get Config
west_city_ls_1_config() {
    global name_config := "west_city_ls_1"
...
setting_GUI_west_city_ls_1() {
    ...
    ChangeButton.OnEvent('Click', ChangeSettingsEvent_west_city_ls_1)

    act_settings_GUI.Show("w220 h300")
}

ChangeSettingsEvent_west_city_ls_1(*) {
